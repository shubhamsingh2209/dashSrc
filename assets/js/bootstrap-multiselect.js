...
! function($) {
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function(element) {
            ...
            var dataId = element.hasAttribute("data-id")? ' data-id='+element.getAttribute("data-id")+" ":'';
            var dataIndustry = element.hasAttribute("data-industry")? ' data-industry="'+element.getAttribute("data-industry")+'" ':'';
            $('label', $li).addClass(inputType);
            $('label', $li).append('<input type="' + inputType + '" name="' + this.options.checkboxName + '" '+dataId+' '+dataIndustry+' />');
